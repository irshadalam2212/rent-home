...
const Table = forwardRef<HTMLElement, TableProps>((props, ref) => {
    ...
    return (
        <div className={classNames(overflow && 'overflow-auto  sticky-table-height')}>
...
export const StickTable = forwardRef<HTMLElement, TableProps>((props, ref) => {
    const {
        asElement: Component = 'table',
        cellBorder,
        children,
    ...
    return (
        <div className={classNames(overflow && 'pe-2')}>
            <Component className={tableClass} {...rest} ref={ref}>
                {children}
            </Component>
        </div>
