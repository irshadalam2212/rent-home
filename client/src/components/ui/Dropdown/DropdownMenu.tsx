...
>((props, forwardedRef) => {
    ...
    const { floatingStyles, refs, context } = useFloating<HTMLElement>({
        ...
        middleware: [
            // offset({ mainAxis: -40, crossAxis: 453 }),
            flip(), 
            shift()
        ],
                        ...
                        <FloatingPortal>
                            ...
                            >
                                <div
                                    ...
                                    // style={{
                                    //      ...floatingStyles,
                                    //     transform: "translate(392px, 8px)" }}
                                >
                                    <ul
                                        className={classNames(
                                            'dropdown-menu min-w-[160px] overflow-y-auto hide-scrollbar',
                                            menuClass,
                                        )}
                                        style={{ maxHeight: '22rem', ...styles }} // max-height can be customized
                                    >
                                        {children}
                                    </ul>
                                </div>
